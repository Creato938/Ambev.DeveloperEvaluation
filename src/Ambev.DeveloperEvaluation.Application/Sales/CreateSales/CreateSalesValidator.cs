...
/// </summary>
public class CreateSalesCommandValidator : AbstractValidator<AddSaleCommand>
{
    /// <summary>
    ...
    public CreateSalesCommandValidator()
    {
        ...
        RuleFor(user => user.ClientName).NotEmpty().Length(3, 50);
        RuleFor(user => user.Phone).Matches(@"^\+?[1-9]\d{1,14}$");
        RuleFor(user => user.ItemList).NotEmpty();
    }
}